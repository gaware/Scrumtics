<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="atividade_edicao.aspx.cs" Inherits="Scrumtics.atividade_edicao" %>
    ...
    <div class="container theme-showcase" role="main">
        <form runat="server" id="Form1" class="form-signin">
            <div class="form-signin-heading">
                <h3>Cadastro da atividade <%=Atividade%></h3>
            </div>
            ...
            <input type="hidden" name="id" value="<%=Atividade%>" />
            <br />
            <asp:Button runat="server" ID="ButtonConfirm1" Text="Modificar atividade" OnClick="ButtonConfirm1_Click" CssClass="btn btn-lg btn-success" />
        </form>
